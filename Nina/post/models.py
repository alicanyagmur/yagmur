...
class Post(models.Model):
    ...
    def __str__(self):
        return self.title
    # str fonksiyonu özel bir fonksiyon postlar object olarak gözükürler bu fonsiyon sayesinde string olarak görüyoruz.
    ...
    class Meta:
        ordering = [
            '-publishing_date' # Başına - koyduğumuzdan en sonra başlıyor.
        ]
